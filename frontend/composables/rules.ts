...
const youtubeUrlPattern = /^https:\/\/www\.youtube\.com\/watch\?v=[\w-]+(?:&[\w%=]*)*$/
...
export const youtubeUrlRule = () => (value: string, textError = 'Invalid YouTube URL') => youtubeUrlPattern.test(value) || textError
